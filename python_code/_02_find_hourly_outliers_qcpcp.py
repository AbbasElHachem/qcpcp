...
for ex, event_date in enumerate(stn_df_biggest_interp.index):
    try:
        ...
        if str(event_date) == '2008-05-14 08:00:00':
            ...
            if diff_obsv_interp_O0 >= 3:
                ...
                if str(event_date) == '2008-05-14 08:00:00':
                    plot_config_event_radar(event_date=event_date,
                                            ...
                                            y_ngbrs=y_dwd_all,
                                            out_dir=out_dir,
                                            radar_file=path_to_radar_image_1,
                    ...
                    plot_config_event_radar(event_date=event_date,
                                            ...
                                            y_ngbrs=y_dwd_all,
                                            out_dir=out_dir,
                                            radar_file=path_to_radar_image_2,
...
stn_df_biggest_interp.to_csv(os.path.join(out_dir,
                                          'interp_obsv_vals.csv'),
                             sep=';')
